...
`r badger::badge_runiverse(pkg = "geoAr", user = "politicaargentina")``r badger::badge_devel("politicaargentina/geoAr", "green")`
...
To cite package ‘geoAr’ in publications use:
  ...
  _Juan Pablo Ruiz Nicolini and Patricio Del Boca (2023). geoAr: Argentina's Spatial Data Toolbox. R package version 0.0.1.4.2.1. <https://github.com/PoliticaArgentina/geoAr>_
