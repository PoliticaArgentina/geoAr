...
Permite realizar búsquedas sobre el listado de provincias. Realiza la
consulta GET al endpoint /provincias de georef-ar-api. Si existe
...
- max:
  ...
  máximo de 24 para este endpoint.
...
[georef-ar-api/provincias](https://datosgobar.github.io/georef-ar-api/open-api/#/Recursos/get_provincias)
